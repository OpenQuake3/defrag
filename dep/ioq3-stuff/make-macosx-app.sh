...
for ARCH in $SEARCH_ARCHS; do
	...
	# TEAMARENA
	if [ -e ${BUILT_PRODUCTS_DIR}/${TEAMARENADIR}/${IOQ3_CGAME} ]; then
		IOQ3_MP_CGAME_ARCHS="${BUILT_PRODUCTS_DIR}/${TEAMARENADIR}/${IOQ3_CGAME} ${IOQ3_MP_CGAME_ARCHS}"
	fi
	if [ -e ${BUILT_PRODUCTS_DIR}/${TEAMARENADIR}/${IOQ3_GAME} ]; then
		IOQ3_MP_GAME_ARCHS="${BUILT_PRODUCTS_DIR}/${TEAMARENADIR}/${IOQ3_GAME} ${IOQ3_MP_GAME_ARCHS}"
	fi
	if [ -e ${BUILT_PRODUCTS_DIR}/${TEAMARENADIR}/${IOQ3_UI} ]; then
		IOQ3_MP_UI_ARCHS="${BUILT_PRODUCTS_DIR}/${TEAMARENADIR}/${IOQ3_UI} ${IOQ3_MP_UI_ARCHS}"
	fi
...
if [ ! -d "${BUILT_PRODUCTS_DIR}/${EXECUTABLE_FOLDER_PATH}/$TEAMARENADIR" ]; then
	mkdir -p "${BUILT_PRODUCTS_DIR}/${EXECUTABLE_FOLDER_PATH}/$TEAMARENADIR" || exit 1;
fi
...
# TEAMARENA
action "${BUNDLEBINDIR}/${TEAMARENADIR}/${CGAME_NAME}"	"${IOQ3_MP_CGAME_ARCHS}"
action "${BUNDLEBINDIR}/${TEAMARENADIR}/${GAME_NAME}"		"${IOQ3_MP_GAME_ARCHS}"
action "${BUNDLEBINDIR}/${TEAMARENADIR}/${UI_NAME}"		"${IOQ3_MP_UI_ARCHS}"
symlinkArch "${CGAME}"	"${CGAME}"	""	"${BUNDLEBINDIR}/${TEAMARENADIR}"
symlinkArch "${GAME}"	"${GAME}"	""	"${BUNDLEBINDIR}/${TEAMARENADIR}"
symlinkArch "${UI}"		"${UI}"		""	"${BUNDLEBINDIR}/${TEAMARENADIR}"
