...
if [ -d ${BUILD_DIR} ]; then
	...
	do
		...
		if [ -f ${BUILD_DIR}/TEAMARENA/${EXEC_SO} ]; then
        		${INSTALL_BIN} ${BUILD_DIR}/TEAMARENA/${EXEC_SO} ${PKG_BUILD_DIR}/TEAMARENA/${EXEC_SO}
		fi
	done
	...
	do
		...
		if [ -f ${BUILD_DIR}/TEAMARENA/vm/${EXEC_VM} ]; then
        		${INSTALL_BIN} ${BUILD_DIR}/TEAMARENA/vm/${EXEC_VM} ${PKG_BUILD_DIR}/TEAMARENA/vm/${EXEC_VM}
		fi
	done
