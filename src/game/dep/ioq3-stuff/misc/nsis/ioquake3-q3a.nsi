...
Section "Quake III Team Arena" sec_q3ta
  ...
  File "TEAMARENA/pak1.pk3"
  File "TEAMARENA/pak2.pk3"
  File "TEAMARENA/pak3.pk3"

  CreateShortCut "$SMPROGRAMS\ioquake3\Team Arena.lnk" "$INSTDIR\ioquake3.x86.exe" "+set fs_game TEAMARENA" "$INSTDIR\ioquake3.x86.exe" 0 "" "" "Team Arena"
...
Section /o "Quake III Team Arena CDROM" sec_q3tacd
	...
	StrCmp $q3ta_pak0 "notfound" 0 q3tapak0copy
		call findq3tacd
	q3tapak0copy:
	CopyFiles $q3ta_pak0 "$INSTDIR\TEAMARENA"
...
Function findq3tacd_cb
	StrCpy $R1 "$9Setup\TEAMARENA\pak0.pk3"
...
Section "un.Quake III Arena and Team Arena" sec_un_q3a
  ...
  Delete $INSTDIR\TEAMARENA\pak1.pk3
  Delete $INSTDIR\TEAMARENA\pak2.pk3
  Delete $INSTDIR\TEAMARENA\pak3.pk3
...
Section "un.CDROM Data" sec_un_q3a_cd
  ...
  Delete $INSTDIR\TEAMARENA\pak0.pk3
  RMDir "$INSTDIR\baseq3"
  RMDir "$INSTDIR\TEAMARENA"
  RMDir "$INSTDIR"
SectionEnd
