...
int         id3Argc(void);
void        id3Argv(int, char*, int);
void        id3Cmd_ExecuteText(int, const char*);
int         id3FS_GetFileList(const char*, const char*, char*, int);
void        id3GetClientState(uiClientState_t*);
void        id3GetClipboardData(char*, int);
...
void        id3R_AddRefEntityToScene(const refEntity_t*);
