...
void Use_target_startTimer(gentity_t* const self, gentity_t* const other, gentity_t* const activator) {
...
void Use_target_stopTimer(gentity_t* const self, gentity_t* const other, gentity_t* const activator) {
	int const        clNum = activator - g_entities;
	gclient_t* const cl    = activator->client;
